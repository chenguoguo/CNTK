...
public:
    ...
    ComputationNodePtr LatticeFreeMMI(const ComputationNodePtr label, const ComputationNodePtr prediction, const ComputationNodePtr tmap, const ComputationNodePtr smap, const std::wstring nodeName = L"");
